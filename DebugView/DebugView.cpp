...
{
	if(MOONG::DebugView::getLogLevel() <= MOONG::DEBUG_VIEW::LEVEL::TRACE_)
	{
		va_list arg_ptr;
...
{
	if(MOONG::DebugView::getLogLevel() <= MOONG::DEBUG_VIEW::LEVEL::DEBUG_)
	{
		va_list arg_ptr;
...
{
	if(MOONG::DebugView::getLogLevel() <= MOONG::DEBUG_VIEW::LEVEL::INFO_)
	{
		va_list arg_ptr;
...
{
	if(MOONG::DebugView::getLogLevel() <= MOONG::DEBUG_VIEW::LEVEL::WARN_)
	{
		va_list arg_ptr;
...
{
	if(MOONG::DebugView::getLogLevel() <= MOONG::DEBUG_VIEW::LEVEL::ERROR_)
	{
		va_list arg_ptr;
...
{
	if(MOONG::DebugView::getLogLevel() <= MOONG::DEBUG_VIEW::LEVEL::FATAL_)
	{
		va_list arg_ptr;
